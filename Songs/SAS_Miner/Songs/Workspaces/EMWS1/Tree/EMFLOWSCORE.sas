...
LABEL R_genreclassical  = 'Residual: genre=classical' ;
LABEL R_genrerock  = 'Residual: genre=rock' ;
LABEL R_genrepop  = 'Residual: genre=pop' ;
LABEL R_genremetal  = 'Residual: genre=metal' ;
LABEL R_genrejazz  = 'Residual: genre=jazz' ;
LABEL F_genre  = 'From: genre' ;
...
_ARBFMT_9 = PUT( genre , $CHAR9.);
 %DMNORMCP( _ARBFMT_9, F_genre );
...
*****  RESIDUALS R_ *************;
IF  F_genre  NE 'CLASSICAL'
AND F_genre  NE 'ROCK'
AND F_genre  NE 'POP'
AND F_genre  NE 'METAL'
AND F_genre  NE 'JAZZ'  THEN DO;
        R_genreclassical  = .;
        R_genrerock  = .;
        R_genrepop  = .;
        R_genremetal  = .;
 ...
 END;
 ELSE DO;
       R_genreclassical  =  -P_genreclassical ;
       R_genrerock  =  -P_genrerock ;
       R_genrepop  =  -P_genrepop ;
       R_genremetal  =  -P_genremetal ;
       R_genrejazz  =  -P_genrejazz ;
       SELECT( F_genre  );
          WHEN( 'CLASSICAL'  ) R_genreclassical  = R_genreclassical  +1;
          WHEN( 'ROCK'  ) R_genrerock  = R_genrerock  +1;
          WHEN( 'POP'  ) R_genrepop  = R_genrepop  +1;
          WHEN( 'METAL'  ) R_genremetal  = R_genremetal  +1;
          WHEN( 'JAZZ'  ) R_genrejazz  = R_genrejazz  +1;
       END;
 END;
